...
public class IntermediateOperationDemo {
	public static void main(String... args) {
		...
		intList.stream().map(i -> i + ", ").collect(Collectors.toList()).forEach(System.out::print);
		...
		mapList.stream().peek((qwqeqwe) -> System.out.print("(" + qwqeqwe + ")")).collect(Collectors.toList());
		System.out.println();
